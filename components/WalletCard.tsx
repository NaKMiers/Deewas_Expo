              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent onPress={e => e.stopPropagation()}>
                    ...
                    <TransferFundDrawer
                      ...
                      trigger={
                        <View className='flex h-10 w-full flex-row items-center justify-start gap-2 px-5'>
                          <Icon render={LucideArrowRightLeft} size={16} color='#6366f1' />
                  ...
                  <CreateTransactionDrawer
                    ...
                    trigger={
                      <View className='flex h-10 w-full flex-row items-center justify-start gap-2 px-5'>
                        <Icon render={LucidePlus} size={16} />
        ...
        <View className='flex flex-col gap-2 px-4 pb-2'>
          ...
          <Collapsible collapsed={!collapsed}>
            <View className='flex flex-col gap-2'>
              <Item title={t('Income')} value={wallet.income} type='income' />
              <Item title={t('Expense')} value={wallet.expense} type='expense' />
              <Item title={t('Saving')} value={wallet.saving} type='saving' />
              <Item title={t('Invest')} value={wallet.invest} type='invest' />
            </View>
          </Collapsible>
        </View>
...
function Item({ title, type, value }: ItemProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Icon render={renderIcon} color='white' size={22} />
      </View>
