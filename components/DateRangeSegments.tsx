  ...
  return (
    <View className={cn('flex-1')}>
      <View className='flex flex-row items-center justify-between gap-21/2'>
        ...
        <TouchableOpacity className='rounded-full bg-primary/10 p-2' onPress={reset}>
      ...
      <View className='mt-21/2 flex flex-row items-center justify-between gap-2'>
        {/* Previous */}
        <TouchableOpacity onPress={prev} className='rounded-full bg-neutral-700 p-2'>
          <Icon render={LucideChevronLeft} color='white' />
        </TouchableOpacity>
        ...
        {/* Next */}
        <TouchableOpacity onPress={next} className='rounded-full bg-neutral-700 p-2'>
          <Icon render={LucideChevronRight} color='white' />
        </TouchableOpacity>
      </View>
    </View>
  )
