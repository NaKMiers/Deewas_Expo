  ...
  return (
    <View className={cn('flex flex-col gap-2', className)}>
      <View className='flex flex-row items-center justify-between'>
        {/* Previous */}
        <TouchableOpacity onPress={prev} className='flex flex-row items-center justify-center gap-2'>
        ...
        {/* Next */}
        <TouchableOpacity onPress={next} className='flex flex-row items-center justify-center gap-2'>
          <Text className='font-body tracking-wider text-muted-foreground'>
