    ...
    <View className={cn('mx-auto mt-21 w-full max-w-sm', className)}>
      ...
      <View className='mt-6 flex flex-col gap-6'>
        ...
        {!initCategory && !type && (
          <View className='flex flex-col gap-1.5'>
            <View className=''>
              ...
              >
                <Icon render={LucideCircle} size={18} color={checkTranType(form.type).hex} />
                <Text
            ...
            <Collapsible collapsed={!openType} duration={200}>
              <View className='flex flex-col overflow-hidden rounded-lg'>
                {['expense', 'income', 'saving', 'invest'].map(tranType => (
                  <Button
                    ...
                    key={tranType}
                  >
                    <Icon render={LucideCircle} size={18} color={checkTranType(tranType as any).hex} />
                    <Text
        ...
        <View className='-mt-6 flex flex-1 flex-col'>
          <TouchableWithoutFeedback onFocus={() => clearErrors('date')} style={{ marginTop: -30 }}>
